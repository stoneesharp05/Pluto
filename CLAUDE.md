# PLUTO — Voice AI Assistant

## Overview
PLUTO (Just A Rather Very Intelligent System) is a voice-first AI assistant for macOS. It runs locally on your machine, connecting to your Apple Calendar, Mail, Notes, and can spawn Claude Code sessions for development tasks.
...
10. Click to enable audio, speak to PLUTO
...
- `USER_NAME` (optional) — Your name for PLUTO to use
- `CALENDAR_ACCOUNTS` (optional) — Comma-separated calendar emails

## Conventions
- PLUTO personality: British butler, dry wit, economy of language
