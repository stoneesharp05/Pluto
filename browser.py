"""
PLUTO Browser — Playwright-based web browsing capabilities.
...
log = logging.getLogger("pluto.browser")
...
class PlutoBrowser:
    """Playwright-based web browsing for PLUTO."""
    ...
    async def _ensure_browser(self):
        ...
        # Launch VISIBLE browser so user can watch PLUTO browse
    ...
    async def screenshot(self, url: str, path: str = None) -> str:
        ...
        try:
            ...
            if not path:
                tmp = tempfile.mktemp(suffix=".png", prefix="pluto_screenshot_")
                path = tmp
