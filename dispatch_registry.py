"""
PLUTO Dispatch Registry — tracks all active and recent project builds/dispatches.

Persists to SQLite so PLUTO always knows what he's working on,
...
log = logging.getLogger("pluto.dispatch")
